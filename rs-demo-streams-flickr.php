...
// FLICKR USER URL
$user_url = 'https://www.flickr.com/photos/we-are-linkmalloc/';
...
<head>
	...
	<meta name="author" content="LinkMalloc" />
{% include seo.html %}
									...
									<div class="widget clearfix">
										...
										<div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
											<address>
												...
												Hernan Cortes St. Casuntingan<br>
												San Francisco, CA 94107<br>
											</address>
											<abbr title="Phone Number"><strong>Phone:</strong></abbr> <a href="tel:{{ site.phone }}">{{ site.phone }} </a><br>
											<abbr title="Website"><strong>Website:</strong></abbr> {{ site.lmic }}<br>
											<abbr title="Email Address"><strong>Email:</strong></abbr> {{ site.email }}
										</div>
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-right">
							...
							<i class="icon-envelope2"></i> {{ site.email }} <span class="middot">&middot;</span> <i class="icon-headphones"></i> +{{ site.phone }}<span class="middot">&middot;</span> <i class="icon-skype2"></i>{{ site.lmic }}
						</div>
